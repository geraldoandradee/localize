...
$canOrder  = $user->authorise('core.edit.state', 'com_localize_imovel');
$saveOrder = $listOrder == 'a.`ordering`';

if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_localize_imovel&task=imveis.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'imvelList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
	...
	<?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.`state`', $listDirn, $listOrder); ?>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'imveis.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_localize_imovel&task=imvel.edit&id='.(int) $item->id); ?>">
